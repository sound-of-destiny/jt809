...
import jtframework.commons.DataType;
import jtframework.exception.EnumTypeErrorException;
import jtframework.exception.PropertyNameErrorException;
...
public class DecoderJT extends AbstractMessageCodec implements Decoder  {
    ...
    public <T extends PackageData> T decode(ByteBuf buf, Class<? extends AbstractHeader> headerClass, Class<T> bodyClass) {
        MsgHeader header = doDecode(buf, MsgHeader.class);
