...
import cn.edu.sdu.jt809.service.handler.JT809ToUpPlatformHandler;
...
public class UpPlatformInitializer extends ChannelInitializer {
    @Override
    protected void initChannel(Channel ch) throws Exception {
        ...
        pipeline.addLast("terminalHandler", new JT809ToUpPlatformHandler());
